        ...
        <main className="flex-1 w-full max-w-4xl py-12">
          <div className="bg-card/50 backdrop-blur-md rounded-xl border border-border shadow-2xl shadow-primary/10 p-6 md:p-10">
            ...
            <div className="space-y-6 prose prose-invert max-w-none text-foreground/90">
              <p>
                Welcome to WordGlow! These terms and conditions outline the rules and regulations for the use of our application. By accessing this app, we assume you accept these terms and conditions. Do not continue to use WordGlow if you do not agree to all of the terms and conditions stated on this page.
              </p>

              <h2 className="font-headline text-2xl text-accent pt-4">1. License to Use</h2>
              <p>
                Unless otherwise stated, WordGlow and/or its licensors own the intellectual property rights for all material on WordGlow. All intellectual property rights are reserved. You may access this from WordGlow for your own personal use subjected to restrictions set in these terms and conditions.
              </p>
              <p>You must not:</p>
              <ul className="list-disc pl-6 space-y-2">
                <li>Republish material from WordGlow</li>
                <li>Sell, rent or sub-license material from WordGlow</li>
                <li>Reproduce, duplicate or copy material from WordGlow</li>
                <li>Redistribute content from WordGlow</li>
              </ul>

              <h2 className="font-headline text-2xl text-accent pt-4">2. User Content</h2>
              <p>
                In these terms and conditions, “your user content” means material (including without limitation text, images, audio material, video material and audio-visual material) that you submit to this app, for whatever purpose. You grant to WordGlow a worldwide, irrevocable, non-exclusive, royalty-free license to use, reproduce, adapt, publish, translate and distribute your user content in any existing or future media.
              </p>

              <h2 className="font-headline text-2xl text-accent pt-4">3. Limitation of Liability</h2>
              <p>
                In no event shall WordGlow, nor any of its officers, directors and employees, be held liable for anything arising out of or in any way connected with your use of this app whether such liability is under contract. WordGlow, including its officers, directors and employees shall not be held liable for any indirect, consequential or special liability arising out of or in any way related to your use of this app.
              </p>
